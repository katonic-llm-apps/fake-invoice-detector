                                ...
                                {"type": "text", "text": """You are reviewing an invoice and comparing it to database . Based on the cases below, follow the inspection criteria and note your findings in the justification section.
                                                ...
                                                CASE 3: Changes in Sign & Stamp
                                                    Inspection Criteria:
                                                        ...
                                                        If in case when the given image has sign or stamp, and database images doesn't have or vise-verse then mark it as ✅ because there is no comparison.
                                                        Note: If the sign is missing in any of the records then mark it as ✅ because there is no comparison.Also,when the stamp is missing in any of the records then mark it as ✅ because there is no comparison.
                                                    Inspection Check:
                                                        ...
                                                        Is the style same for sign or stamp of same vendor in the database?
                                                    Remark:
                                                        if sign or stamp is present in given image and database then check If any changes are found in the signature or stamp by the same vendor to the database.If crteria fulfils ,mark it as ❌.  If the answer is "NA", replace it with ✅.
